...
//importe dos Json com dadaos da api que iremos precisar estao nos dados
const Hero = ({
        ...
        <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container">
          ...
          <div className="flex items-center">
            <img
              src={img}
              alt="hero-img/img"
              className="w-auto h-[40vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[14vh] transitions-theme -rotate-[25deg] hover:rotate-0 cursor-pointer object-fill"
            />
          </div>
        </div>
      </div>
